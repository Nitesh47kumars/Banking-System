      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl shadow-2xl overflow-hidden relative">
        ...
        {success && (
          <div className="absolute inset-0 z-50 bg-slate-900 flex flex-col items-center justify-center p-6 text-center">
            ...
            <p className="text-slate-400 mt-2">₹{Number(amount).toLocaleString('en-IN')} is on its way to {toAccount}</p>
            <button 
              onClick={() => {setSuccess(false); setAmount(""); setToAccount("")}}
        ...
        <div className="p-6 border-b border-slate-800 flex justify-between items-center bg-slate-800/30">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-amber-500 rounded-lg flex items-center justify-center text-slate-900 font-bold">B/S</div>
            <span className="font-semibold tracking-wide uppercase">Banking System</span>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          <div>
            <h1 className="text-xl font-semibold text-white text-center">Send Money</h1>
            <p className="text-slate-500 text-sm text-center">Funds are transferred instantly to the recipient</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <span className="absolute left-4 top-3 text-amber-500 font-semibold">₹</span>
              <input
                required
                type="number"
                placeholder="0.00"
          ...
          <div className="bg-slate-950/50 rounded-xl p-4 border border-slate-800">
            <div className="flex justify-between items-center">
              ...
              <span className="text-emerald-500 text-xs font-bold bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20 uppercase">Free</span>
            </div>
